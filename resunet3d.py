...
class ResidualBlock(nn.Module):
    def __init__(self, in_c, out_c, stride=1):
        ...
        self.c1 = nn.Conv3d(in_c, out_c, kernel_size=(3, 3, 3), stride=stride, padding=1)
        self.b2 = BatchNormReLU(out_c)
        self.c2 = nn.Conv3d(out_c, out_c, kernel_size=(1, 1, 1), stride=1, padding=0)

        """for skip connection"""
        self.s = nn.Conv3d(in_c, out_c, kernel_size=(1, 1, 1), stride=stride, padding=0)
...
class ResUNet3D(nn.Module):
    def __init__(self):
        ...
        """Encoder 1"""
        self.c11 = nn.Conv3d(3, 64, kernel_size=(3, 3, 3), padding=1)
        self.br1 = BatchNormReLU(64)
        self.c12 = nn.Conv3d(64, 64, kernel_size=(3, 3, 3), padding=1)

        self.c13 = nn.Conv3d(3, 64, kernel_size=(1, 1, 1), padding=0)
        ...
        """Output"""
        self.output = nn.Conv3d(64, 1, kernel_size=(1, 1, 1), padding=0)
        self.sig = nn.Sigmoid()
